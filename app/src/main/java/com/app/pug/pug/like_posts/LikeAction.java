package com.app.pug.pug.like_posts;
...
/**
 * Created by zeryan on 2/18/16.
 */
public class LikeAction extends AsyncTask<Void, Void, Boolean> {
    private AppCompatActivity context;
    private JSONObject passedJson;
    private String url_address = ActivityMainDataSet.url_address;
    private int like;

    public LikeAction(AppCompatActivity context, JSONObject likeJson) {
    ...
    public void setLikeAction(int action) {
        this.like = action;
    }
